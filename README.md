...
Bash
eg: git clone https://github.com/Tulasi9427/IntelliSQL-Intelligent-SQL-Querying-with-LLMs-Using-Gemini-Pro.git
...
1.Kukkala Naga Tulasi (Team Leader): AI Specialist & Project Manager 

2.Macharla Meghana: QA Engineer & Documentation 

3.Mandadi keerthi: Frontend Developer & UI/UX Designer 

4.Mekala Vasanthi: Backend Developer & Data Engineer
